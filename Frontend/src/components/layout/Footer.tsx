...
export const Footer: React.FC = () => {
    return (
        <footer className="bg-black/50 backdrop-blur-md border-t border-white/5 text-white py-12 mt-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            ...
                            <li><a href="/view-books" className="text-gray-300 hover:text-orange-500 transition-colors">Library</a></li>
                            <li><a href="/add-book" className="text-gray-300 hover:text-orange-500 transition-colors">Add Book</a></li>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            {[FaGithub, FaTwitter, FaLinkedin].map((Icon, i) => (
                                <a key={i} href="#" className="w-10 h-10 rounded-full bg-gray-400 flex items-center justify-center text-gray-600 hover:bg-orange-500 hover:text-white transition-all duration-300">
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-300">
